...
public class get_json_data extends AppCompatActivity {
...
Button getdata=(Button)findViewById(R.id.buttonGet);
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(get_json_data.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    get_json_data.this, contactList,
                    R.layout.list_item, new String[]{"id", "calories",
                    "date"}, new int[]{R.id.name,
